...
@ApiModel
public class LibraryComposerQuery implements Serializable {
    ...
    public LibraryComposerQuery setLibraryId(String libraryId) {
    ...
    public LibraryComposerQuery setLibraryIds(String[] libraryIds) {
