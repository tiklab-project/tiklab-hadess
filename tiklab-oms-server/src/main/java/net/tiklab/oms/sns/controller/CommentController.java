...
import  net.tiklab.sns.comandlikes.model.Comment;
import  net.tiklab.sns.comandlikes.model.CommentQuery;
import  net.tiklab.sns.comandlikes.service.CommentService;
