...
import net.tiklab.updownload.product.model.ProductUrl;
import net.tiklab.updownload.product.model.ProductUrlQuery;
import net.tiklab.updownload.product.service.ProductUrlService;
