...
import  net.tiklab.download.product.model.ProductUrl;
import  net.tiklab.download.product.model.ProductUrlQuery;
import  net.tiklab.download.product.service.ProductUrlService;
