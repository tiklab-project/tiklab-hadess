...
import  net.tiklab.tenant.tenant.model.TenantDis;
import  net.tiklab.tenant.tenant.model.TenantDisQuery;
import  net.tiklab.tenant.tenant.service.TenantDisService;
