...
import  net.tiklab.promotion.coupon.model.CouponDraw;
import  net.tiklab.promotion.coupon.model.CouponDrawQuery;
import  net.tiklab.promotion.coupon.service.CouponDrawService;
