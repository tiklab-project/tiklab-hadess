package com.tiklab.oms.role.controller;

import com.alibaba.fastjson.JSONObject;
import com.tiklab.core.Result;
import com.tiklab.oms.config.TestConfig;
import com.tiklab.oms.role.model.RoleUser;
...
public class RoleUserControllerTest {
    ...
    private static Logger logger = LoggerFactory.getLogger(RoleUserControllerTest.class);
    ...
    public void test01ForSaveRoleUser() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(roleUser));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/roleUser/createRoleUser")
