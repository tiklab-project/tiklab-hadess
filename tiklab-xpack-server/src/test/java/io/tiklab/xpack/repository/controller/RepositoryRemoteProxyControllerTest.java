...
public class RepositoryRemoteProxyControllerTest {

    private static Logger logger = LoggerFactory.getLogger(RepositoryRemoteProxyControllerTest.class);
    ...
    public void test01ForSaveRepositoryRemoteProxy() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(repositoryRemoteProxy));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/repositoryRemoteProxy/createRepositoryRemoteProxy")
    ...
    public void test02ForUpdateRepositoryRemoteProxy(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/repositoryRemoteProxy/updateRepositoryRemoteProxy")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindRepositoryRemoteProxy() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/repositoryRemoteProxy/findRepositoryRemoteProxy")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllRepositoryRemoteProxy() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/repositoryRemoteProxy/findAllRepositoryRemoteProxy")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteRepositoryRemoteProxy(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/repositoryRemoteProxy/deleteRepositoryRemoteProxy")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
