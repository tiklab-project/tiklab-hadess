...
public class RepositoryClusterCfgCodeGeneratorTest extends CodeGeneratorTemplate {
    ...
    protected CodeGeneratorConfig getCodeGeneratorConfig() {
        ...
        config.setEntity(RepositoryClusterCfgEntity.class);
        config.setPkg("io.tiklab.xpack.repository");
        config.setModel("RepositoryClusterCfg");
        return config;
    }
