...
public class LibraryMavenControllerTest {

    private static Logger logger = LoggerFactory.getLogger(LibraryMavenControllerTest.class);
    ...
    public void test01ForSaveLibraryMaven() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(libraryMaven));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/libraryMaven/createLibraryMaven")
    ...
    public void test02ForUpdateLibraryMaven(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/libraryMaven/updateLibraryMaven")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindLibraryMaven() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/libraryMaven/findLibraryMaven")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllLibraryMaven() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/libraryMaven/findAllLibraryMaven")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteLibraryMaven(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/libraryMaven/deleteLibraryMaven")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
