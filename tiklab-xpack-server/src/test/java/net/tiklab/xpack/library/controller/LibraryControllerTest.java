...
public class LibraryControllerTest {
    ...
    private static Logger logger = LoggerFactory.getLogger(LibraryControllerTest.class);
    ...
    public void test01ForSaveLibrary() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(library));
