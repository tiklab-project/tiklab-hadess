...
public class LibraryVersionControllerTest {

    private static Logger logger = LoggerFactory.getLogger(LibraryVersionControllerTest.class);
    ...
    public void test01ForSaveLibraryVersion() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(libraryVersion));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/libraryVersion/createLibraryVersion")
    ...
    public void test02ForUpdateLibraryVersion(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/libraryVersion/updateLibraryVersion")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindLibraryVersion() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/libraryVersion/findLibraryVersion")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllLibraryVersion() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/libraryVersion/findAllLibraryVersion")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteLibraryVersion(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/libraryVersion/deleteLibraryVersion")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
