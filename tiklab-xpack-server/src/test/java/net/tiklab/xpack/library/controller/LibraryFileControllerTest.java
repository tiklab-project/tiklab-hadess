...
public class LibraryFileControllerTest {

    private static Logger logger = LoggerFactory.getLogger(LibraryFileControllerTest.class);
    ...
    public void test01ForSaveLibraryFile() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(libraryFile));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/libraryFile/createLibraryFile")
    ...
    public void test02ForUpdateLibraryFile(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/libraryFile/updateLibraryFile")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindLibraryFile() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/libraryFile/findLibraryFile")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllLibraryFile() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/libraryFile/findAllLibraryFile")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteLibraryFile(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/libraryFile/deleteLibraryFile")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
