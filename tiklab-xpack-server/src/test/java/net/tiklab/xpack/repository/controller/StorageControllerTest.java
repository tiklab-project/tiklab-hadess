...
public class StorageControllerTest {
    ...
    private static Logger logger = LoggerFactory.getLogger(StorageControllerTest.class);
    ...
    public void test01ForSaveStorage() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(storage));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/storage/createStorage")
