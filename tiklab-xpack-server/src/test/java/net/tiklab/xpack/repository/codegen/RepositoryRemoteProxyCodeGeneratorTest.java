...
public class RepositoryRemoteProxyCodeGeneratorTest extends CodeGeneratorTemplate {
    ...
    protected CodeGeneratorConfig getCodeGeneratorConfig() {
        ...
        config.setEntity(RepositoryRemoteProxyEntity.class);
        config.setPkg("net.tiklab.xpack.repository");
        config.setModel("RepositoryRemoteProxy");
        return config;
    }
