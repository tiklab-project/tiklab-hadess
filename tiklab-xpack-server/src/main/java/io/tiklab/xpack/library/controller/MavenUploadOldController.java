...
import io.tiklab.xpack.library.service.MavenUploadOldService;
...
@RestController
@RequestMapping("/xpack02")
@Api(name = "LibraryMavenController",desc = "Maven提交拉取")
public class MavenUploadOldController {

    @Autowired
    MavenUploadOldService downloadMavenService;
